...
setuptools.setup(
    name="rqalpha_minsec_trade_realtime",
    version="1.2.1",
    author="yanjlee",
    author_email="yanjlee@163.com",
    description="基于开源rqalpha4.0版本，支持分钟和tick级别的回测.",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/rqalpha_minsec_trade_realtime",  # 模块github地址
